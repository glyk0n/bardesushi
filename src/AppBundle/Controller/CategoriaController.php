...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@App/categoria/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('@App/categoria/new.html.twig', array(
    ...
    public function showAction(Categoria $categorium)
    {
        ...
        return $this->render('@App/categoria/show.html.twig', array(
            'categorium' => $categorium,
    ...
    public function editAction(Request $request, Categoria $categorium)
    {
        ...
        return $this->render('@App/categoria/edit.html.twig', array(
            'categorium' => $categorium,
    ...
    private function createDeleteForm(Categoria $categorium)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('@App/categoria_delete', array('id' => $categorium->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
